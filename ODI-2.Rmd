...
merge(top_bf_resource, middle_bf_resource, "match_id") %>%
  summarize(match_id = match_id, top_bf_pct = top_bf_pct, middle_bf_pct = middle_bf_pct, x = top_bf_pct + middle_bf_pct)
```
