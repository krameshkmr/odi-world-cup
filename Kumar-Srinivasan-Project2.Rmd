...
We can analyze our model's accuracy by testing it on a random match. We randomly sampled a 2007 match between Bangladesh and New Zealand. The actual `mov` for the match was -0.413 and the predicted `mov` was -0.619. Our predicted value is off by 0.206, which indicates that our model is fairly accurate.
